...
@interface MVWallAdManager : NSObject

/**
 @prpperty
 
 @abstract The Facebook PlacementID is used to request ads from Facebook. You can also set the placementID in our portal. The ID you set in our portal will replace the ID you set here in future.
 
 */
@property (nonatomic, strong, nullable) NSString *fbPlacementId;
